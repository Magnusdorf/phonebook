...
app.config['MYSQL_DATABASE_PASSWORD'] = 'magnus123'
...
# Write a function named `init_todo_db` create phonebook table within Anonymous_phonebook db, if it doesn't exist
